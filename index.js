...
const anisounds  = require('./animalsounds.js');
var messages = [
    {
        'welcome':"<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_bridge_01'/>Welcome to the world of animals.<break time=\"0.5s\"/> Say animal name to hear the sound of the animal.<break time=\"0.5s\"/> Say help if you need help",
        'repmsg':"<audio src='soundbank://soundlibrary/alarms/chimes_and_bells/chimes_bells_06'/>Hello <break time=\"0.5s\"/>Say animal name if you want to hear the sound of the animal",
        'helpmsg':"<audio src='soundbank://soundlibrary/alarms/chimes_and_bells/chimes_bells_04'/>Say the name of animal and you will hear the voice of the animal. Thank you",
        'stopmsg':"<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_positive_response_02'/>Hope you enjoyed. Thank You"
    }
];
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = messages[0].welcome

        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt(messages[0].repmsg)
            .getResponse();
    }
};
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = messages[0].helpmsg
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = messages[0].stopmsg
